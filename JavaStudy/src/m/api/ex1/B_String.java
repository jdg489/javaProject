...
public class B_String {
	...
	public void method01() {
		...
		// String 클래스에서 equalse 메소드는 이미 오버라이딩이 되어있음(주소값이 아닌 값비교)
		System.out.println(str1.equals(str2));
		
		// String 클래스에서 hashCode 메소드는 이미 오버라이딩이 되어있음(주소값이 아닌 문자열을 가지고 만들도록) 
		...
		// 새로운 곳을 참조하도록 한다.(새로운 주소값 부여받음 == 주소값 변경)
	}
	...
	public void method02() {
		...
		System.out.println("str1에 Hello라는 문자열이 포함 되어있는가? " + str1.contains("Hello"));
		System.out.println("str1에 Hello라는 문자열이 포함 되어있는가? " + str1.contains("Bye"));
		
		// 4. 문자열.substring(int beginIndex, [int endIndex]) : String
		// 문자열을 beginIndex 위치부터 endIndex 위치까지 추출해서 반환
		...
		// 6. 문자열.toLowerCase() : String => 문자열을 전부 소문자로 변경해서 반환
